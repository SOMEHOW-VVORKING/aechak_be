 ...
 * application 패키지를 추가로 쓰게 되면 그 패키지가 요구하는 포트 어댑터(infra)·조립(config)도 함께 늘린다.
 */
@SpringBootApplication(
    scanBasePackages = [
        "com.aechak.seller",             // 이 모듈 — 컨트롤러·조립
        "com.aechak.webcommon",          // 전역 예외 핸들러·응답 규격
        "com.aechak.websecurity",        // JWT 디코더·상태 필터 부품
        "com.aechak.pii",                // PII 암호화 엔진·키 조립(PiiCryptoConfig)
