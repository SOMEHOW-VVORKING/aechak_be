...
-- recent_searches: (user_id, keyword) 유일 제약으로 중복 키워드를 한 행으로 접고,
--                  keyword는 as_cs 콜레이션이라 대소문자를 구분한다. 공백과 유니코드 정규화는 검색 기록 경로 티켓에서 처리.
...
(
    ...
    keyword     VARCHAR(255) COLLATE utf8mb4_0900_as_cs NOT NULL,
    searched_at DATETIME(6)  NOT NULL,
    created_at  DATETIME(6)  NOT NULL,
    updated_at  DATETIME(6)  NOT NULL,
    PRIMARY KEY (id),
    CONSTRAINT uk_recent_searches_user_keyword UNIQUE (user_id, keyword),
