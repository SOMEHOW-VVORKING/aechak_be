...
interface SocialIdentityJpaRepository : JpaRepository<SocialIdentity, Long> {
    fun findByProviderAndProviderId(provider: SocialProvider, providerId: String): SocialIdentity?
}
...
class SocialIdentityRepositoryAdapter(
    ...
    override fun findByProviderAndProviderId(provider: SocialProvider, providerId: String): SocialIdentity? =
        jpaRepository.findByProviderAndProviderId(provider, providerId)
